...
## Deploy (Heroku)
1. Go to Heroku and create a new app (eg: `your-tk-name`)
2. Install [Heroku CLI](https://devcenter.heroku.com/articles/heroku-cli)
3. `heroku login`
4. `mkdir your-tk-name && cd your-tk-name`
5. `git init`
6. `heroku git:remote -a your-tk-name`
7. Download this repo and copy all files into `your-tk-name` folder
8. `npm i`
...
## Preview
![Preview](https://raw.githubusercontent.com/DavideViolante/tk-framework/master/demo.gif "Preview")
